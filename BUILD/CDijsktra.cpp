...
CDijsktra::~CDijsktra()
{
 ...
 /**************************************************************
 * METHODE : 
 * PRESENTATION : Cherches le chemin le plus court entre un point A et un point B définis.
 *
 * **************************************************************/
...
/**************************************************************
* METHODE :
* PRESENTATION : Cherches le chemin le plus court entre un point Source unique et un point B définis.
*
* **************************************************************/
